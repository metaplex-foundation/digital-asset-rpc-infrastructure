...
pub struct Model {
    ...
    pub required_collection: Option<Vec<u8>>,
...
impl ColumnTrait for Column {
    ...
    fn def(&self) -> ColumnDef {
        match self {
            ...
            Self::Limit => ColumnType::Integer.def().null(),
            Self::Burn => ColumnType::Boolean.def().null(),
            Self::RequiredCollection => ColumnType::Binary.def().null(),
