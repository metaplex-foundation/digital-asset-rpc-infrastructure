...
#[sea_orm(
    rs_type = "String",
    db_type = "Enum",
    enum_name = "batch_mint_persisting_state"
)]
pub enum BatchMintPersistingState {
    ...
    ReceivedTransaction,
    #[sea_orm(string_value = "start_processing")]
    StartProcessing,
...
#[sea_orm(
    rs_type = "String",
    db_type = "Enum",
    enum_name = "batch_mint_fail_status"
)]
pub enum BatchMintFailStatus {
    #[sea_orm(string_value = "batch_mint_verify_failed")]
