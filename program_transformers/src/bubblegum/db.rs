use {
    ...
    sea_orm::{
        ...
        query::{QueryFilter, QuerySelect, QueryTrait},
    ...
    T: ConnectionTrait + TransactionTrait,
{
    ...
    for p in change_log_event.path.iter() {
        ...
        let audit_item: Option<cl_audits::ActiveModel> = if cl_audits {
            ...
            ai.tx = ActiveValue::Set(txn_id.to_string());
            Some(ai)
        } else {
            None
        };
    ...
    T: ConnectionTrait + TransactionTrait,
{
    let model = asset::ActiveModel {
        ...
        owner_delegate_seq: ActiveValue::Set(Some(seq)), // gummyroll seq
        ..Default::default()
    };
    ...
    T: ConnectionTrait + TransactionTrait,
{
    let model = asset::ActiveModel {
        ...
        was_decompressed: ActiveValue::Set(was_decompressed),
        ..Default::default()
    };
    ...
    T: ConnectionTrait + TransactionTrait,
{
    let model = asset_creators::ActiveModel {
        ...
        creator: ActiveValue::Set(creator),
    ...
    T: ConnectionTrait + TransactionTrait,
{
    ...
    let model = asset_grouping::ActiveModel {
        ...
        verified: ActiveValue::Set(Some(verified)),
