...
pub fn delegate<'c>(parsing_result: &'c BubblegumInstruction, bundle: &'c InstructionBundle<'_>, txn: &'c DatabaseTransaction) -> Pin<Box<dyn Future<Output=Result<(), IngesterError>> + Send + 'c>> {
    Box::pin(async move {
