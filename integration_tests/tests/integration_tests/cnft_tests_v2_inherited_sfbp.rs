...
pub async fn run_inherited_sfbp_scenario_test(
    ...
    for events in seed_permutations {
        ...
        let royalty = response.royalty.as_ref().expect("royalty should be present");
        ...
        let creators = response.creators.as_ref().expect("creators should be present");
...
async fn test_mint_v2_inherited_sfbp_resolves_collection_royalty_and_creators() {
    ...
    let tree_sig = "5aFu7ARYYaLXRLQAQXMfpxK26oeqA3LzuxjPJ7rXNdsXn9kySgLSQYxvpPHxje8n4yGrWjMw4Z4jjyr39W2NyEB7";
    let mint_sig = "4CS8k5FDLm8p1EYWyhF16nZXdG4dFmDjUah3SzSxU4QLpbthivNT26dwiAzPoXJPi3jEmXobciDpd1G71yTWci4F";
